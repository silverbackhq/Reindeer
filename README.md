...
<p align="center">
    ...
    <p align="center">
        ...
        <a href="https://github.com/silverbackhq/Reindeer/releases"><img src="https://img.shields.io/badge/Version-1.1.1-blue.svg"></a>
...
$ java -jar build/libs/reindeer-1.1.1-fat.jar --env=/path/to/.env
```
